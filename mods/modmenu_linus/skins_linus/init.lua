...
-- Have fun !
print("check goto skins_linus MOD************************") --linus added--
...
skins.modpath = minetest.get_modpath("skins_linus")
print("check point minetest.get_modpath skin_linus" )
print(skins.modpath)
...
skins.update_player_skin = function(player)
	...
	print("check point get_player_name()--------------")
	print(name)
	print(skins.get_type(skins.skins[name]))

	print("check point skins.skins[name]--------------")
	print(name)
	print(skins.skins[name])
