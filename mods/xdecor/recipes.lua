...
minetest.register_craft({
	...
	{"", "", ""},
	{"", "", ""},
	{"default:stick", "lantern:candle", "default:stick"}
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe = {"default:book","craft_guide:sign_wall","dye:violet"}
})

minetest.register_craft({
	output = "xdecor:crafting_guide",
	type = "shapeless",
	recipe = {"default:book","craft_guide:sign_wall_locked","dye:violet"}
})
