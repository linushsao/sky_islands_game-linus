...
local npc_trader_prototype = {
		...
		trader_inventory = {
				goods = {
          { "markers:mark 4","","bitchange:minecoin 1"},
...
--          { "default:torch 2","","bitchange:mineninth 2"},
          ...
          { "marssurvive:sp 1","","default:diamond 1"},
          { "marssurvive:air_gassbotte 1","","default:diamond 1"},
          { "marssurvive:airgen5 1","","default:diamond 1"},
